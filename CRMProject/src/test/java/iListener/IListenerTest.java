...
public class IListenerTest extends TestBase implements ITestListener {
    ...
    public void onTestFailure(ITestResult result) {
       ...
       ExtentTest test = extent.createTest(result.getMethod().getMethodName()).assignAuthor("anish").assignDevice("chrome");
        ...
        test.addScreenCaptureFromPath("D:\\SelenumGit\\CRMProject\\ScreenShots" + result.getMethod().getMethodName() + ".png");
        extent.flush();
    }
